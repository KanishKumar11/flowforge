  ...
  return (
    ...
    >
      <Handle
        ...
        className="w-2.5! h-2.5! rounded-md! bg-primary! border! border-primary! top-[-6px]! transition-all duration-300 group-hover:border-primary! group-hover:bg-primary/10!"
      />

      <div className="flex items-center gap-3">
        <div
          className={`p-1.5 rounded-md border border-border ${colorMap[data.type] || "bg-blue-500/10 text-blue-500"} transition-colors duration-300 group-hover:border-primary`}
        >
