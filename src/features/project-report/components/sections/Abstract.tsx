      ...
      <div className="pt-12 pb-20">
        ...
        <div className="max-w-3xl mx-auto px-8 space-y-4 text-justify leading-relaxed text-[11pt]">
          <p className="report-paragraph text-sm first-letter:text-3xl first-letter:font-bold first-letter:float-left first-letter:mr-2 first-letter:leading-none">
            ...
            <strong>Flowgent 1.0</strong>, a visual workflow automation platform
            that democratizes process automation through an intuitive, no-code
            interface.
          </p>
          ...
          <p className="report-paragraph text-sm">
            ...
            <strong>React Flow</strong>. The platform supports various trigger
            types including webhooks, scheduled (cron-based) execution, and
            manual triggers. It features a comprehensive node system with 20+
            node types spanning HTTP operations, AI integrations, data
            transformation, conditional logic, and third-party service
            connections.
          </p>
          ...
          <div className="border border-gray-400 p-3 my-3">
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="space-y-1">
                ...
                <p>
                  <strong>UI:</strong> Tailwind CSS, Shadcn/UI, React Flow
                </p>
                <p>
                  <strong>Backend:</strong> tRPC for type-safe APIs
                </p>
              </div>
              <div className="space-y-1">
                <p>
                ...
                <p>
                  <strong>Execution:</strong> Inngest for durable workflows
                </p>
                <p>
                  <strong>Auth:</strong> Better Auth with OAuth support
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="report-paragraph text-sm">
            Key features include <strong>team collaboration</strong> with
            role-based access control (Owner, Admin, Member, Viewer),{" "}
            <strong>credential management</strong> with encrypted storage,{" "}
            <strong>AI-powered automation</strong> through integrations with
            OpenAI, Anthropic, and Google Gemini, and{" "}
            <strong>execution monitoring</strong> with detailed logs and
            analytics.
          </p>

          <p className="report-paragraph text-sm">
            The project follows the <strong>Agile methodology</strong> with
            two-week sprints, emphasizing iterative development and continuous
            feedback. The system was designed with scalability in mind,
            utilizing industry-standard practices for security, performance
            optimization, and maintainable code architecture.
          </p>
        ...
        <div className="max-w-3xl mx-auto mt-6 px-8">
          ...
          <p className="text-xs text-gray-700">
            Workflow Automation, No-Code Platform, Visual Editor, Next.js, React
            Flow, Inngest, tRPC, AI Integration, Team Collaboration, Process
            Automation
          </p>
        </div>
      </div>
