  ...
  return (
    <div className="report-page page-break-after report-section relative">
      ...
      <div className="max-w-3xl mx-auto px-8 py-2 text-right border-b border-gray-300 mb-8">
        <span className="text-xs uppercase tracking-widest text-gray-500">Chapter 1: Introduction</span>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-8 space-y-5 text-justify leading-relaxed">
        ...
        <p className="report-paragraph text-base first-letter:text-4xl first-letter:font-bold first-letter:float-left first-letter:mr-2 first-letter:leading-none">
          <strong>Flowgent 1.0</strong> is a modern, visual workflow automation platform that
          empowers users to design, execute, and monitor automated workflows through
          an intuitive drag-and-drop interface. Built as a full-stack web application,
          it addresses the growing need for accessible automation tools that don't
          require programming expertise.
        </p>

        <p className="report-paragraph text-base">
          The platform enables users to automate repetitive tasks, integrate various
          services, and create sophisticated business processes using a visual canvas
          where nodes represent individual actions and edges define the flow of data
          and execution.
        </p>
        ...
        <h2 className="report-h2 text-xl font-bold mt-6">1.2 Background & Motivation</h2>

        <p className="report-paragraph text-base">
          The digital transformation of businesses has created an unprecedented demand
          for automation solutions. According to industry reports, businesses spend
          approximately <strong>30-40% of their time on repetitive, manual tasks</strong> that
          could be automated.
        </p>

        <p className="report-paragraph text-base">
          While enterprise automation platforms like Zapier, Make (formerly Integromat),
          and n8n exist, they often come with significant costs, learning curves, or
          limitations. Small and medium businesses frequently find these solutions
          either too expensive or too complex for their needs.
        </p>
        ...
        <h2 className="report-h2 text-xl font-bold mt-6">1.3 Scope of the Project</h2>
        ...
        <div className="grid grid-cols-1 gap-2 my-4">
          <div className="border-l-4 border-black pl-4 py-2">
            <strong>User Management:</strong> Complete authentication system with email/password and OAuth support, user profiles, and session management.
          </div>
          <div className="border-l-4 border-gray-400 pl-4 py-2">
            <strong>Workflow Design:</strong> Visual editor with drag-and-drop functionality, node palette, configuration panels, and canvas controls.
          </div>
          <div className="border-l-4 border-black pl-4 py-2">
            <strong>Execution Engine:</strong> Durable workflow execution using Inngest, supporting parallel processing and automatic retries.
          </div>
          <div className="border-l-4 border-gray-400 pl-4 py-2">
            <strong>Team Collaboration:</strong> Multi-user teams with role-based permissions (Owner, Admin, Member, Viewer).
          </div>
        </div>

        <h2 className="report-h2 text-xl font-bold mt-6">1.4 Report Organization</h2>
