...
const figures = [
  ...
  { number: "1.3", title: "Project Module Structure", page: "5" },
  {
    number: "2.1",
  ...
  { number: "3.1", title: "Project Objectives Hierarchy", page: "19" },
  {
    number: "4.1",
  ...
  { number: "5.1", title: "LOC Distribution by Module", page: "36" },
  { number: "5.2", title: "Risk Assessment Matrix", page: "37" },
  { number: "5.3", title: "Project Timeline — Gantt Chart", page: "38" },
  {
    number: "5.4",
  ...
  { number: "6.3", title: "SDLC Phase — Effort Distribution", page: "44" },
  { number: "6.4", title: "Agile Sprint Cycle", page: "46" },
  { number: "6.5", title: "User Requirements Questionnaire", page: "53" },
