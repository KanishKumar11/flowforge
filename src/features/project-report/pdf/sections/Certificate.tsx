...
<<<<<<< HEAD
            ...
            submitted to{" "}
            <Text style={styles.bold}>
              PG Department of Computer Science and Application, Hindu College,
              Amritsar
            </Text>
            ...
            6th semester, is a bonafide work carried out by{" "}
            <Text style={styles.bold}>Kanish Kumar</Text> (Roll No:{" "}
            <Text style={styles.bold}>11792312331</Text>) under our supervision
            and guidance.
          </Text>

          <Text style={[styles.paragraph, { marginTop: 16 }]}>
            The work has been completed by the candidate under our supervision,
