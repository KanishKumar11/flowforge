  ...
  return (
    <Card className="bg-(--arch-bg-secondary) border-(--arch-border) text-(--arch-fg) shadow-none rounded-none h-full">
      ...
      <CardContent className="space-y-4">
        <Button
          variant="outline"
          className="w-full justify-between h-12 bg-transparent border-(--arch-border) text-(--arch-fg) hover:bg-(--arch-fg) hover:text-(--arch-bg) hover:border-(--arch-fg) transition-all rounded-none group"
          asChild
        >
          <Link href="/workflows">
